...
# Only exact, measured PM-table profiles are accepted; gnr_smu owns the
...
# and no measurement behind either; research/dangerous/probe_tdc_edc.py settled it
# by read-back and they were the wrong way round, so the dialog had been sending
# the TDC box to EDC.
