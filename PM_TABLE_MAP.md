...
This is not a valid CC6 cross-check: the exact C0 complement establishes this field
as CC1. The kernel comparison is retained only as an observation about idle
accounting, not as evidence for a C-state label.
...
| 0x700 | 448 | ~36.9 → ~55.3 | N | **CCD1 L3 Cache temperature (°C)** — not the core average. A shared 64 MiB L3 workload raised it +6.97 K versus +1.05 K for an ALU-only control at nearly the same final core/Tccd1 temperatures. | HIGH |
...
| d[349-356] CC1 Residency | 93%→0.5% | stress-ng load | exact complement of C0; idle value is background-dependent, see above | YES |
| d[333-340] Core Power | 0.4→5.4W | Pkg Power split | coherent | YES |
| d[341-348] C0 Residency | 7→99% | full load | exact complement of CC1 | YES |
...
| d[448] 0x700 | 36.9→55.3 | core temp average d[317-324] | 36.4→78.3°C | **NO — it is the CCD1 L3 Cache temperature, not the core average** |
...
| 0x700/0x704 d[448/449] | Average / Min Core Temp | d[448] is CCD1 L3 Cache temperature; d[449] remains a related unidentified thermal lane |
