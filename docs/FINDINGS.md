...
- **Status :** Installé (`ryzen_smu-dkms-git`)
- **Détection :** OK (Identifié comme `GraniteRidge`)
- **Version :** 0.1.7
...
sudo ./tools/gnr_monitor

# Modifier le PPT à 85W
sudo python3 tools/smu_advanced.py ppt 85

# Tester un undervolt de -20 sur le Coeur 0
sudo python3 tools/smu_advanced.py raw --mb mp1 --msg 0x50 --arg 0xFFFFFFEC
```
