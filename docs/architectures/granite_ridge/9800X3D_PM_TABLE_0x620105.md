...
| Category | Indices |
|----------|---------|
| CONFIRMED (struct / cross-validated against a system sensor) | 120 |
| HIGH confidence (strong pattern match) | 117 |
| MED confidence (inferred) | 78 |
| LOW confidence (guess) | 34 |
| Untagged / unknown | 108 |
